...
class _trash_ScreenState extends State<trash_Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: 
      NoteData().Trashlist.isEmpty ? Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Padding(padding: const EdgeInsets.only(left: 10), child: My_widget()),
          Padding(
         ...
         Row(
           ...
           children: [
             Icon(Icons.hourglass_empty,color: Colors.purple.shade900,size: 20,),
             Text("Empty")
           ],
         )
        ],
